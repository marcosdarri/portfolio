const WorkHistory = () => {
  return (
    <ul
      className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical dark:bg-slate-800 dark:text-slate-400"
      id="about"
    >
      <li>
        <hr />
        ...
        <div className="timeline-end mb-10">
          <time className="font-mono italic">Present Time</time>
          <div className="text-lg font-black dark:text-white">iMac</div>
      ...
      <li>
        ...
        <div className="timeline-end mb-10">
          ...
          <div className="text-lg font-black dark:text-white">Brokerware</div>
